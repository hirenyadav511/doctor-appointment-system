...
const loginAdmin = async (req, res) => {
    try {
        ...
        // Dev-friendly defaults: if you haven't configured admin creds yet, use these.
        // For production, set ADMIN_EMAIL and ADMIN_PASSWORD in backend/.env
...
const addDoctor = async (req, res) => {
    ...
    try {
        ...
        // Doctor image is OPTIONAL.
        // If an image is provided and Cloudinary is configured, upload it.
