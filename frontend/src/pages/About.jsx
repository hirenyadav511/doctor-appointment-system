    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          <p>
            Welcome to Medicare, your trusted partner in managing your
            healthcare needs conveniently and efficiently. At Medicare, we
          ...
          <p>
            ...
            managing ongoing care, Medicare is here to support you every step of
            the way.
          </p>
