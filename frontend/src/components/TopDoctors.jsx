...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 dark:text-gray-100 md:mx-10'>
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-blue-50 text-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:border dark:border-gray-700 px-12 py-3 rounded-full mt-10 hover:bg-blue-100 dark:hover:bg-gray-700 transition-colors'>more</button>
        </div>
    )
}
